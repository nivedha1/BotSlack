...
cultureBot.controller('CultureBotController', function ($window,CultureBotService) {
    ...
    var scopes = 'users:read,groups:read,groups:write,chat:write:bot,channels:write,channels:read,bot,admin';
    var base_url = 'https://slack.com';
vm.hrefInit = base_url+'/oauth/authorize?scope='+scopes+'&client_id='+client_id;
    function init() {
        vm.newState=false;
